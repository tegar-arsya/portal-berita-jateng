            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h2 class="mb-4" style="text-align: center; color: #4e73df;">Galeri Berita</h2>
                        </div>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">GALERI BERITA</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        if ($result -> num_rows > 0 ) {
                                            while ($row = $result-> fetch_assoc()){
                                                ...
                                                echo "<tr>
                                                    ...
                                                    <td>" . $row["title"] . "</td>
                                                    <td>" . $row["oleh"] . "</td>
                                                    <td><img src='../../Assets/User-img/$imageSrc' alt='' style='max-width: 200px; max-height: 150px;'></td>
                                                </tr>";
                                            }
                                        }
                                        ?>
